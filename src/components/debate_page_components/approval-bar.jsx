...
const ApprovalBar = ({ leftPercentage = 50, rightPercentage = 50 }) => {
  ...
  return (
    <div className="flex items-center w-full space-x-2">
      <img src={leftProfilePic || DefaultLeftPic}  alt="Left User" className="w-20 h-20 rounded-full object-cover" />
      ...
      <img src={rightProfilePic || DefaultRightPic} alt="Right User" className="w-20 h-20 rounded-full object-cover" />
    </div>
  );
};
